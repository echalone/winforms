...
namespace System.Windows.Forms
{
    internal static class TextExtensions
    {
        ...
        public static void DrawText(
            ...
            => DrawText(hdc.HDC, text, hfont, bounds, foreColor, flags, backColor, padding);
            ...
            TextPaddingOptions padding = default)
        {
            ...
            User32.DRAWTEXTPARAMS dtparams = GetTextMargins(hfont, padding);
        ...
        /// </summary>
        public static float GetOverhangPadding(this Gdi32.HFONT hfont)
        {
            ...
            return GetFontHeight(hfont) / 6f;
        }

        public static int GetFontHeight(this Gdi32.HFONT hfont)
        {
            ...
            using var fontSelection = new Gdi32.SelectObjectScope(hdc, hfont);
            using var mapMode = new Gdi32.SetMapModeScope(hdc, Gdi32.MM.TEXT);
        ...
        public static Size MeasureText(
            ...
            Size proposedSize,
            User32.DT flags)
            => MeasureText(hdc.HDC, text, hfont, proposedSize, flags);
            ...
            User32.DT flags)
        {
            ...
            User32.DRAWTEXTPARAMS dtparams = GetTextMargins(hfont);
